    ...
    <div className="max-w-4xl mx-auto px-4 sm:px-6 py-12">
      ...
      <div className="space-y-8 text-sm text-slate-700 dark:text-slate-300 leading-relaxed">
        ...
        <section className="space-y-3">
          ...
          <p>
            Under Article 17 of the General Data Protection Regulation (GDPR), individuals maintain the right to obtain from the controller the erasure of personal data concerning them without undue delay. AllToolsPak.pk fulfills and exceeds this mandate natively:
          </p>
        ...
        <section className="space-y-3">
          ...
          <p>
            <strong>AllToolsPak.pk does NOT sell, rent, lease, trade, or monetize your personal information or document contents under any circumstances.</strong> We do not construct consumer behavioral dossiers, sell personal data to marketing brokers, or track individual users across unrelated digital domains.
          </p>
        </section>
        ...
        <section className="space-y-3">
          ...
          <p>
            You can utilize all 8 tools on AllToolsPak.pk without enabling cookies. Our core utilities do not require login authentication, session cookies, or user tracking cookies.
          </p>
          <p>
            We strictly limit cookie storage to:
          </p>
          <ul className="list-disc pl-5 space-y-1 text-xs text-slate-600 dark:text-slate-400">
            <li><strong>Strictly Necessary:</strong> Local storage key <code className="bg-slate-100 dark:bg-slate-800 px-1 py-0.5 rounded">theme</code> (light/dark preference) and <code className="bg-slate-100 dark:bg-slate-800 px-1 py-0.5 rounded">alltoolspak_consent</code> (recording your cookie preference).</li>
        ...
        <section className="space-y-3">
          ...
          <div className="p-4 rounded-xl bg-slate-50 dark:bg-slate-800/60 border border-slate-200 dark:border-slate-700/80 space-y-1 text-xs">
            <p className="font-bold text-slate-900 dark:text-white">AllToolsPak Data Protection Officer (DPO)</p>
            <p>Fareed Ullah</p>
